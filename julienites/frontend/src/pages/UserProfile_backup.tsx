  ...
  return (
    <div className="min-h-screen bg-background-primary text-text-primary">
      ...
      <div className="max-w-[1265px] mx-auto px-4 py-6">
        ...
        {/* Recent Posts */}
        <div className="mt-8">
          <h2 className="text-2xl font-bold mb-4">My Recent Posts</h2>
          <div className="space-y-4">
            {/* Sample Post */}
            <div className="bg-background-secondary rounded-xl border border-border p-6">
              <div className="flex gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-text-tertiary text-sm">@{currentUser.username} • 2 days ago</div>
                </div>
              </div>
              <div className="mb-4">
                Excited to connect with fellow Julienites on this platform! Looking forward to networking and sharing experiences. #Julienites #AlumniNetwork
              </div>
