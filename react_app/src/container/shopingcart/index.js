...
export default function ShopingCart(props = {}) {
  ...
  let [openShopingCartDrawer, setOpenShopingCartDrawer] = useState(false);
  function loadItemComponent() {
    if (categorySelected.name === "Men") {
      ...
      return (
        <div style={styles.comingSoon}>Children's products coming soon.</div>
      );
  ...
  return (
    <div className="shoping-cart" style={styles.container}>
      <div style={styles.headerSection}>
        <Header openShopingCartDrawer={setOpenShopingCartDrawer} />
      </div>
      <div style={styles.categorySection}>
        <Category onCategorySelect={setCategorySelected} />
      </div>
      <div style={styles.itemsSection}>{loadItemComponent()}</div>
      <Drawer isOpen={openShopingCartDrawer} />
    </div>
  );
}
